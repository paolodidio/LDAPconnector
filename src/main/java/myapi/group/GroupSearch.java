...
LdapConnection conn;
	...
	public GroupSearch(LdapConnection connection) {
		conn = connection;
	}
	...
	public List<String> search(boolean equals,String filter) {
		...
		filt = LdapFilter.forNativeFilter(filter);}
		 ...
		 CustomHandler handler = new CustomHandler();
		    new LdapSearch(conn, ObjectClass.GROUP, filt, handler, new OperationOptionsBuilder().setPageSize(500).build()).execute();
	...
	public List<String> searchAllOccurrences(boolean equals,String attribute) {
		...
		filt = LdapFilter.forNativeFilter("("+attribute+"=*)");}
		 ...
		 CustomHandler handler = new CustomHandler();
		    new LdapSearch(conn, ObjectClass.GROUP, filt, handler,  new OperationOptionsBuilder().build()).execute();
	...
	public List<String> searchAllOccurrencesShort(boolean equals,String attribute) {
				...
				filt = LdapFilter.forNativeFilter("("+attribute+"=*)");}
				 ...
				 CustomHandler handler = new CustomHandler();
				   ...
				   new LdapSearch(conn, ObjectClass.GROUP, filt, handler, ops).execute();
	...
	public List<String> searchDeterminedOccurrence(boolean equals,String attribute, String value, int pageSize) {
		...
		CustomHandler handler = new CustomHandler();
		 ...
		 new LdapSearch(conn, ObjectClass.GROUP, filt, handler, new OperationOptionsBuilder().setPageSize(pageSize).build()).execute();
		    System.out.println("Print search with filter "+ filt.getNativeFilter()+":");
		    handler.printObjects();
		    System.out.println();
	...
	public List<String> searchDeterminedOccurrenceShort(boolean equals,String attribute, String value) {
		...
		CustomHandler handler = new CustomHandler();
		 if (ops != null) {
		    new LdapSearch(conn, ObjectClass.GROUP, filt, handler, ops).execute();}
		 else {new LdapSearch(conn, ObjectClass.GROUP, filt, handler, new OperationOptionsBuilder().build()).execute();}
		    System.out.println("Print search with filter "+ filt.getNativeFilter()+":");
		    handler.printObjects();
		    System.out.println();
	...
	//SearchSubstring**** search method where you need to write the attribute and the substring you want to search, overloaded with custom pageSize
		...
		/*
	//those private method are used to create the OperationOptions that fits the best the previous search functions
		
	private OperationOptions optionsShort(String attribute) {
	...
	private OperationOptions optionsShort(String attribute, int pageSize) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
	...
	private OperationOptions optionsSort(String attribute, boolean ascending) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		//default is 500
		builder.setPageSize(500);
	...
	private OperationOptions optionsSort(String attribute, boolean ascending, int pageSize) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		builder.setPageSize(pageSize);
		SortKey key =new SortKey(attribute, ascending);
        builder.setSortKeys(key);
	...
	private OperationOptions optionsSort(String attribute, boolean ascending, String sortBy) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		//default is 500
		builder.setPageSize(500);
	...
	private OperationOptions optionsSort(String attribute, boolean ascending, int pageSize, String sortBy) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		builder.setPageSize(pageSize);
		SortKey key =new SortKey(sortBy, ascending);
        builder.setSortKeys(key);
	...
	private OperationOptions optionsSortShort(String attribute, boolean ascending) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		//default is 500
		builder.setPageSize(500);
	...
	private OperationOptions optionsSortShort(String attribute, boolean ascending, int pageSize) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		builder.setPageSize(pageSize);
        builder.setAttributesToGet(attribute);
        SortKey key =new SortKey(attribute, ascending);
	...
	private OperationOptions optionsSortShort(String attribute, boolean ascending, String sortBy) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		//default is 500
		builder.setPageSize(500);
	...
	private OperationOptions optionsSortShort(String attribute, boolean ascending, int pageSize, String sortBy) {
		OperationOptionsBuilder builder = new OperationOptionsBuilder();
		builder.setPageSize(pageSize);
        builder.setAttributesToGet(attribute, sortBy);
        SortKey key =new SortKey(sortBy, ascending);
